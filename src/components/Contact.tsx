  ...
  return (
    <section id="contact" className="flex flex-col gap-8 justify-between items-center">
      ...
      <div className="flex flex-row justify-center items-center w-full md:gap-2 gap-1 text-center text-yellow-500">
        <MdSend className="md:text-4xl text-3xl" />
        <h2 className="md:text-3xl text-2xl">Contact Us</h2>
      </div>

      <div className="flex xl:flex-row w-fit flex-col-reverse gap-5 md:p-10 sm:p-8 p-6 bg-yellow-50 shadow-xl rounded-3xl">
