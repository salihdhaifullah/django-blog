...
const Footer = () => {
  return (
    <footer className="flex flex-col w-full bg-[url('/footer.jpg')]  bg-no-repeat object-cover md:h-screen h-[1200px] bg-center items-start justify-end mt-10">
      <div className="md:pt-8 pt-4 pb-2 lg:px-10 md:px-8 sm:px-6 px-4 flex flex-col gap-8 bg-yellow-100 w-full shadow-lg">
        ...
        <div className="flex justify-center items-center">
          ...
          <div className="flex flex-row flex-wrap justify-center items-center gap-12 text-gray-500 w-full">

            <div className="flex flex-col gap-4 items-center h-full text-center min-w-[200px]">
        ...
        <div className="flex gap-2 flex-col justify-center items-center text-gray-500">
          ...
          <h3 className="text-base text-center">Copyright 2024 ©, Developed by <a href="https://github.com/salihdhaifullah" className="hover:underline text-blue-500">Salih Dhaifullah</a>, Powered by <a href="https://quicksite.guru/" className="hover:underline text-blue-500">quicksite.guru</a></h3>
        </div>
