...
const About = () => {
  return (
    <div className="flex flex-col gap-8 rounded-lg md:pt-24 pt-16 lg:px-12 md:px-8 sm:px-6 px-4 w-full" id="about">

      <div className="flex flex-col justify-center items-center w-full gap-4">
        <div className="flex flex-row md:text-3xl text-2xl md:gap-2 gap-1 text-center justify-center text-yellow-500">
      ...
      <div className="flex lg:gap-2 lg:flex-row flex-col gap-10 justify-evenly items-center w-full">
      <img src="/location.jpg" alt="View from Spectrum" className="lg:w-[45%] w-full h-auto rounded-lg" />

        <div className="flex w-full justify-center items-center">
          <div className="flex flex-col gap-8 max-w-xl">
            <div className="flex flex-col gap-2">
              <div className="flex flex-row gap-2 text-center items-center text-yellow-600">
